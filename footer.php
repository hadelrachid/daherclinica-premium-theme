                ...
                <div class="footer-grid">
                    ...
                    <div class="footer-links">
                        <h4><?php _e('Institucional', 'daherclinica'); ?></h4>
                            ...
                            ?>
                            <li><a href="<?php echo esc_url($login_url); ?>" target="_blank" style="color: #FFD700; font-weight: bold;"><i class="fas fa-lock" style="margin-right: 5px;"></i><?php _e('Área Restrita', 'daherclinica'); ?></a></li>
                        </ul>
                    </div>
